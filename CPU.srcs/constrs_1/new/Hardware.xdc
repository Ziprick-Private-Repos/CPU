...
set_property IOSTANDARD LVCMOS33 [get_ports {hardInterrupt[0]}]
set_property PULLTYPE PULLUP [get_ports {hardInterrupt[0]}]
set_property PACKAGE_PIN F13 [get_ports {hardInterrupt[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hardInterrupt[1]}]
set_property PULLTYPE PULLUP [get_ports {hardInterrupt[1]}]
set_property PACKAGE_PIN E13 [get_ports {hardInterrupt[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hardInterrupt[2]}]
set_property PULLTYPE PULLUP [get_ports {hardInterrupt[2]}]
set_property PACKAGE_PIN D14 [get_ports {hardInterrupt[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hardInterrupt[3]}]
set_property PULLTYPE PULLUP [get_ports {hardInterrupt[3]}]
