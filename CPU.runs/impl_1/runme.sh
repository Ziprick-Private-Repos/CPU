...
HD_PWD='X:/Programming Archive/##Current Projects Backup##/Hardware/FPGA/CPU/CPU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IO.tcl -notrace
