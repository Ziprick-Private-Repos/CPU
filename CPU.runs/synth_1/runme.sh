...
HD_PWD='X:/Programming Archive/##Current Projects Backup##/Hardware/FPGA/CPU/CPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IO.tcl
