...
synth_design -top IO -part xc7a35tfgg484-1
...
write_checkpoint -force -noxdef IO.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file IO_utilization_synth.rpt -pb IO_utilization_synth.pb"
